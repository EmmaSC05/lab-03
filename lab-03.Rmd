...
author: "Emma Crawford, Saba Sitter, Xuanjie Lin,Ariuna Zonorov and Kiet Lam - Group 7 IDS"
date: "`r Sys.Date()`"
...
The number of Chinese speakers should not show "1,026 billion". It should either be "1.026 billion", or "1,026 million".
...
Needs to be a key, not clear what is being represented. Pie chart is not ideal for comparing two variables.
...
no title and no scale on axis, lacks clarity
